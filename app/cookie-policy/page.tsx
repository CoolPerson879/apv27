  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <Card>
        ...
        <CardContent>
          <p className="mb-4">
            This Cookie Policy explains how RajScape Inc. ("Company," "we,"
            "us," and "our") uses cookies and similar technologies to recognize
            you when you visit our website at https://apworld.rajscape.com
          ...
          <p className="mb-4">
            Cookies set by the website owner (in this case, RajScape Inc.) are
          ...
          <p className="mb-4">
            ...
            choose which categories of cookies you accept or reject. Essential
          ...
          <p className="mb-4">
            ...
            Website Storage Settings Panel. You can also control Flash Cookies
            by going to the Global Storage Settings Panel and following the
            instructions (which may include instructions that explain, for
          ...
          <p className="mb-4">
            ...
            technologies, please email us at support@rajscape.com or by post to:
            RajScape Inc., 235 W Van Buren St, Chicago, IL 60607, USA Chicago,
            IL 60607 United States Phone: (+1)2245588478
          </p>
        </CardContent>
      </Card>
    </div>
